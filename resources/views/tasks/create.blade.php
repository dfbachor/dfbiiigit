            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" id="taskForm" method="post" action="/tasks/store" enctype="multipart/form-data"> 
                            {{ csrf_field() }}
                            <div class="form-group">
                                <label for="task" class="control-label col-sm-3">Task:<strong style="color:darkred;">*</strong></label> 
                                <div class="col-sm-9">
                                    <input class="form-control" type="text" id="task" name="task" placeholder="task" data-error="task is required" required> 					    
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">	
                                    <input class="form-control"  id="openDate" name="openDate" value="" placeholder="04/20/2018" data-error="date is invalid" required>
                                </div> 
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">	
                                    <input class="form-control" id="closedDate" name="closedDate" value="" placeholder="04/20/2018" data-error="date is invalid">
                                </div> 
                            </div>
                            ...
                            <input type="submit" id="addtaskSubmitButton" class="btn btn-info" value="Add task">

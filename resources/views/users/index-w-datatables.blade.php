                ...
                <div class="panel panel-default panel-success">
                    <div class="panel-heading col-sm-2" style="height: 50px; padding: 1px">
                        <a href='#' id="userPhotoAnchor">					            	
                            <img class="companyLogo img-rounded" id="userPhoto" src="{{ route('image', ['filename' => app('system')->imageFileName]) }}" height='48' width='48' />
                        </a> 
                    </div>
        ...
        function showUserDetail(user) {
            ...
            var myUser = user[key].name + " " + "<br>";
                ...
                if(user[key].imageFileName == null)
                    ...
                    userImg = '{{ route('image', ['filename' => app('system')->imageFileName]) }}'


                else 
                    userImg = '/image/' + user[key].imageFileName; // cannot use route() since its an ajax call
